...
<body class="no-skin">
	...
	<script src="<c:url value='/template/admin/js/sneaker-add.js' />"></script>
	<script src="<c:url value='/template/admin/js/sneaker-list.js' />"></script>
	...
	<script src="<c:url value='/template/admin/js/brandsneaker-list.js' />"></script>
	...
	<script src="<c:url value='/template/admin/js/u-save.js' />"></script>
