...
<head>
   <title>Quản lý nhà đất</title>
	...
	<link rel="stylesheet" href="<c:url value='https://fonts.googleapis.com/css?family=PT+Serif:400,400i,700,700ii%7CRoboto:300,300i,400,400i,500,500i,700,700i,900,900i&amp;subset=cyrillic' />" />
    ...
    <link rel="stylesheet" href="<c:url value='/template/web/css/flexslider.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/web/css/swiper.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/web/css/style.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/web/css/media.css' />" />
